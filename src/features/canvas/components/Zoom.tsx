...
export function Zoom({
  ...
  return (
    <div
      className="absolute bottom-4 right-3.5 flex items-center gap-1 bg-[#f9f6f0]/95 border border-black/10 rounded-md px-2 py-1 shadow-[0_4px_16px_rgba(13,13,13,0.07)] backdrop-blur-xl z-40"
