...
export default function Toolbar({ mode, setMode }: ToolbarProps) {
  return (
    <nav className="absolute left-3.5 top-1/2 -translate-y-1/2 flex flex-col gap-0.5 bg-[#f9f6f0]/95 border border-black/10 rounded-xl px-1.5 py-1.5 shadow-[0_8px_30px_rgba(13,13,13,0.09)] backdrop-blur-xl z-40">
      {TOOL_LIST.map((t, i) =>
        t === null ? (
